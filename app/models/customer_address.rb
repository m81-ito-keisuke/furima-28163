class CustomerAddress
  ...
  def save
    Customer.create(item_id: @item.id, user_id: @user.id)
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, house_number: house_number, building_name: building_name, phone_bumber: phone_number, customer_id: @customer.id )
  end
end